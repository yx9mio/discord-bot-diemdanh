// index.js — Entry point (Sapphire JS Edition)
'use strict';
require('dotenv').config();
const Sentry = require('@sentry/node');

// Sentry khởi tạo sớm nhất
...
// Sapphire: bulk overwrite slash commands khi dev
...
const client = new SapphireClient({
  ...
  // Sapphire tự scan: commands/, listeners/, interaction-handlers/, preconditions/
